...
HugeInteger< T > HugeInteger< T >::operator-( HugeInteger &op2 )
{
   ...
   //typename T::pointer diffSize = difference.integer.end() - 1;  //差的最高位數
   ...
   typename T::iterator it4 = difference.integer.end() - 1;
...
HugeInteger< T > HugeInteger< T >::operator*( HugeInteger &op2 )  ////
{
   ...
   if( isZero() || op2.isZero() )
    ...
    typename T::iterator it2 = product.integer.end() - 1;
    for (; *it2 == 0; it2--)
...
HugeInteger< T > HugeInteger< T >::operator/( HugeInteger &op2 )
{
   ...
   typename T::iterator it1 = quotient.integer.end() - op2.integer.size();
   for (; it1 >= quotient.integer.begin(); it1--)
   {
       while (buffer <= remainder)
       {
           ...
           if (remainder.isZero())
           {
               typename T::iterator it2 = quotient.integer.end() - 1;
               for (; *it2 == 0; it2--)
